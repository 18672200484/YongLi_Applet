...
namespace CMCS.Common.Utilities.RedisLib
{
    ...
    public class RedisHelper
    {
        ...
        private  readonly CommonAppConfig appConfig = CommonAppConfig.GetInstance();
        ...
        public RedisHelper(int dbNum, string readWriteHosts)
        {
            ...
            _conn = string.IsNullOrWhiteSpace(readWriteHosts) ?
                    RedisConnectionHelp.Instance(dbNum) :
                    RedisConnectionHelp.GetConnectionMultiplexer(dbNum, readWriteHosts);
            //_conn.GetServer(appConfig.RedisIP).FlushDatabase(dbNum);
        }
        ...
        {
            var server = _conn.GetServer(appConfig.RedisIP);
